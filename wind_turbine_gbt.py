...
# MAGIC %md-sandbox # Wind Turbine Predictive Maintenance with Databricks <img src="https://mikem-docs.s3-us-west-2.amazonaws.com/img/wind_turbines.jpg" style="float:right; height: 300px; margin: 5px; padding: 5px; border: 1px solid #ddd;"/>
# MAGIC ### Vibration Analysis
# MAGIC 
